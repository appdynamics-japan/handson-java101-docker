...
headers0= \
  [ NVPair('Accept', '*/*'),
    NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/supercars.do'), ]
...
headers2= \
  [ NVPair('Accept', '*/*'),
    NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/cars.do?query=manu&mid=3'), ]
...
headers4= \
  [ NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
    NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/car.do?query=car&cid=2'), ]

url0 = 'http://supercars-tomcat:8080'
...
class TestRunner:
  ...
  def page5(self):
    ...
    self.token_query = \
      'save'
    result = request501.POST('/Cars_Sample_App/enquire.do' +
      '?query=' +
      self.token_query,
      ( NVPair('name', 'appd'),
  ...
  def page6(self):
    ...
    result = request601.GET('/Cars_Sample_App/supercars.do', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/enquire.do?query=save'), ))
    self.token_query = \
      httpUtilities.valueFromBodyURI('query') # 'manu'
  ...
  def page14(self):
    ...
    self.token_query = \
      'save'
    result = request1401.POST('/Cars_Sample_App/sell.do' +
      '?query=' +
      self.token_query,
      ...
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Content-Type', 'application/x-www-form-urlencoded'),
        NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/sell.do'), ))
  ...
  def page17(self):
    ...
    result = request1701.GET('/Cars_Sample_App/supercars.do', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/about.do'), ))
    self.token_query = \
      httpUtilities.valueFromBodyURI('query') # 'manu'
  ...
  def page23(self):
    ...
    result = request2301.GET('/Cars_Sample_App/supercars.do', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/cars.do?query=manu&mid=8'), ))
    # 15 different values for token_mid found in response, using the first one.
    self.token_mid = \
      httpUtilities.valueFromBodyURI('mid') # '3'
  ...
  def page27(self):
    ...
    result = request2701.GET('/Cars_Sample_App/supercars.do', None,
      ( NVPair('Accept', 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'),
        NVPair('Referer', 'http://supercars-tomcat:8080/Cars_Sample_App/cars.do?query=manu&mid=1'), ))
    # 15 different values for token_mid found in response, using the first one.
    self.token_mid = \
      httpUtilities.valueFromBodyURI('mid') # '3'
